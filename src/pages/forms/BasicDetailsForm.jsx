        ...
        <Grid spacing={2}>
          ...
          <div className="account-section">
            <Typography variant="h4" className="account-question">
              Do you have account with TJSB Bank?
            </Typography>
              ...
              <Grid container spacing={2} className="account-grid" sx={{ marginLeft: '10px' }}>
                {['yes', 'no'].map((option) => (
                  <Grid item xs={6} key={option}>
                    <FormControlLabel
                      value={option}
                      control={<Radio className="account-radio" />}
            ...
            <Grid item size={{ xs: 12, sm: 10, md: 5 }}>
              <Controller
                ...
                render={({ field, fieldState }) => {
                  const isValidNumber = /^\d{10}$/.test(field.value);
                  return (
              ...
              <FormControlLabel
                ...
                label={
                  <span className={`checkbox-label ${watch('agreeTerms') ? 'checked' : ''}`}>
                    By continuing you agree to TJSB Sahakari Bank Ltd Lending's T&Cs and Privacy
                    Policy.
                  </span>
                }
              ...
              <FormControlLabel
                ...
                label={
                  <span className={`checkbox-label ${watch('agreeDisclosure') ? 'checked' : ''}`}>
                    I/We hereby furnish my consent to TJSB Bank to share and/or fetch any of my/our
            ...
            <Grid item xs={12}>
              <FormControlLabel
                ...
                label={
                  ...
                  >
                    I declare that I am not a director/relative of director of TJSB Bank/any other
                    bank. <a>Read More</a>
                  </span>
                }
              ...
              <FormControlLabel
                ...
                label={
                  <span className={`checkbox-label ${watch('agreeBiometricOTP') ? 'checked' : ''}`}>
                    I/We agree to provide biometric scan or One Time Password (OTP) as received from
                    UIDAI or Aadhar card photocopy details as requested by TJSB Sahakari Bank Ltd.,
                    for my/our KYC formalities.
                  </span>
                }
              />
            </Grid>
              ...
              <FormControlLabel
                ...
                label={
                  <span className={`checkbox-label ${watch('agreeEKYC') ? 'checked' : ''}`}>
                    I/We have no objection for TJSB Bank for downloading, validating, storing,
                    sharing my/our KYC details through TJSB E-KYC online system using my/our Aadhar
                    number
                  </span>
                }
              />
    ...
    <Dialog className="custom-dialog-main" open={isOpen} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent className="dialog-content">
        ...
        <Typography component="p" className="dialog-body">
          I/We hereby furnish my consent to TJSB SAHAKARI Bank to share and/or fetch any of my/our
          information (including my/our sensitive personal information, location etc.) or any other
          device information when TJSB SAHAKARI Bank considers such disclosure/fetching as
          necessary, with/ from:
        </Typography>
        <div className="terms-list">
          <Typography component="p">
            <strong>a)</strong> Agents of TJSB SAHAKARI Bank in any jurisdiction;
          </Typography>
          <Typography component="p">
            ...
            jurisdiction over TJSB SAHAKARI Bank ;
          </Typography>
          <Typography component="p">
            <strong>c)</strong> Service providers, professional advisors, consultants or such
            persons with whom TJSB SAHAKARI Bank contracts or proposes to contract (Collectively
            referred to as "Permitted Persons").
          </Typography>
        </div>
        ...
        <Typography component="p" className="dialog-body">
          I/We hereby authorize TJSB SAHAKARI Bank to get a one-time access to my/our device's
          camera and microphone for the purposes of onboarding and KYC verification which is
          required to be conducted to enable TJSB SAHAKARI Bank to provide the credit facilities
          sought by me/us.
        </Typography>

        {/* Section 3 */}
        <Typography className="dialog-heading">
          3. Consent to TJSB SAHAKARI Bank's Privacy Commitment
        </Typography>
        <Typography component="p" className="dialog-body">
          I/We confirm having read and understood TJSB SAHAKARI Bank's 'Privacy Commitment'
          available at{' '}
          <a href="https://www.tjsb.bank.in/Privacy." target="_blank" rel="noopener noreferrer">
            https://www.tjsb.bank.in/Privacy.
          </a>
          . I/We acknowledge that the same shall be subject to changes by TJSB Bank from time to
        ...
        <Typography component="p" className="dialog-body">
          I authorise TJSB SAHAKARI Bank to disclose such information provided by me to its service
          providers to enable them to contact me for rendering assistance that may be required to
          submit application to TJSB SAHAKARI Bank and complete onboarding formalities.
        </Typography>
      </DialogContent>
  ...
  return (
    <Dialog className="custom-dialog-main" open={isOpen} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle className="dialog-title">
        TJSB Sahakari Bank Ltd Lending Terms & Conditions
      </DialogTitle>
      ...
      <DialogContent className="dialog-content">
        ...
        <Typography className="dialog-body">
          ...
          conditions of TJSB Sahakari Bank Ltd ("the Bank")..
        </Typography>
    ...
    <Dialog className="custom-dialog-main" open={isOpen} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent className="dialog-content">
        ...
        <Typography className="dialog-body" sx={{ mt: 2, fontWeight: 600 }}>
          ...
          internal policies of TJSB Bank.
        </Typography>
      </DialogContent>
